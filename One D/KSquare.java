   ...
   public class KSquare{
      ...
      private boolean dontCareValue;
      
   	
   /**
    Constructor takes parameters matching decimal and binary values along 
    with a variable representation only when designated true by the binary
    value.
   ...
   */	
   ...
   /**
    Sets the 'don't care' value for the square.
    
    @param care The caring variable.
   */	
   
      public void setDontCare(boolean care){
         dontCareValue = care;
      }
      
   
   /**
    Returns the 'don't care' value for the square.
    
     @return Returns the varing value
   */	
   
      public boolean getDontCareValue(){
